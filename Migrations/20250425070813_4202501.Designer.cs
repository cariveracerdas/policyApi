...
namespace policyApi.Migrations
{
    ...
    [Migration("20250425070813_4202501")]
    partial class _4202501
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("policyApi.Models.PolizaModelEntity", b =>
                {
                    ...
                    b.Property<string>("ClienteModelEntityCedulaAsegurado")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("ClienteModelEntityCedulaAsegurado");
            ...
            modelBuilder.Entity("policyApi.Models.PolizaModelEntity", b =>
                {
                    ...
                    b.HasOne("policyApi.Models.ClienteModelEntity", null)
                        .WithMany("Polizas")
                        .HasForeignKey("ClienteModelEntityCedulaAsegurado");
